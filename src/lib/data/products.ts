...
/** Cantidad de fotos locales del catálogo semilla (`public/catalogo-1/{1..N}.png`). */
export const CATALOG_LOCAL_SEED_SLOTS = 64;

/** Catálogo inicial: fotos en `public/catalogo-1/{1..64}.png`. */
export const products: Product[] = [
  ...
  },
  {
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/32.png"],
    isUnique: false
  },
  {
    id: "p33",
    name: "Prenda de Autor #33",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "unisex",
    type: "vestidos",
    ...
    condition: "en buen estado",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/33.png"],
    isUnique: true
  },
  {
    id: "p34",
    name: "Prenda de Autor #34",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "mujer",
    type: "accesorios",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/34.png"],
    isUnique: false
  },
  {
    id: "p35",
    name: "Prenda de Autor #35",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "hombre",
    type: "abrigo",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/35.png"],
    isUnique: true
  },
  {
    id: "p36",
    name: "Prenda de Autor #36",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "unisex",
    type: "tops",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/36.png"],
    isUnique: false
  },
  {
    id: "p37",
    name: "Prenda de Autor #37",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "mujer",
    type: "bottoms",
    ...
    condition: "en buen estado",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/37.png"],
    isUnique: true
  },
  {
    id: "p38",
    name: "Prenda de Autor #38",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "hombre",
    type: "vestidos",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/38.png"],
    isUnique: false
  },
  {
    id: "p39",
    name: "Prenda de Autor #39",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "unisex",
    type: "accesorios",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/39.png"],
    isUnique: true
  },
  {
    id: "p40",
    name: "Prenda de Autor #40",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 30900,
    category: "mujer",
    type: "abrigo",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/40.png"],
    isUnique: false
  },
  {
    id: "p41",
    name: "Prenda de Autor #41",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "hombre",
    type: "tops",
    ...
    condition: "en buen estado",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/41.png"],
    isUnique: true
  },
  {
    id: "p42",
    name: "Prenda de Autor #42",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "unisex",
    type: "bottoms",
    ...
    condition: "en excelente estado",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/42.png"],
    isUnique: false
  },
  {
    id: "p43",
    name: "Prenda de Autor #43",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "mujer",
    type: "vestidos",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/43.png"],
    isUnique: true
  },
  {
    id: "p44",
    name: "Prenda de Autor #44",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "hombre",
    type: "accesorios",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/44.png"],
    isUnique: false
  },
  {
    id: "p45",
    name: "Prenda de Autor #45",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "unisex",
    type: "abrigo",
    ...
    condition: "en buen estado",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/45.png"],
    isUnique: true
  },
  {
    id: "p46",
    name: "Prenda de Autor #46",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "mujer",
    type: "tops",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/46.png"],
    isUnique: false
  },
  {
    id: "p47",
    name: "Prenda de Autor #47",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "hombre",
    type: "bottoms",
    ...
    condition: "en excelente estado",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/47.png"],
    isUnique: true
  },
  {
    id: "p48",
    name: "Prenda de Autor #48",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "unisex",
    type: "vestidos",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/48.png"],
    isUnique: false
  },
  {
    id: "p49",
    name: "Prenda de Autor #49",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "mujer",
    type: "accesorios",
    ...
    condition: "en buen estado",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/49.png"],
    isUnique: true
  },
  {
    id: "p50",
    name: "Prenda de Autor #50",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "hombre",
    type: "abrigo",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/50.png"],
    isUnique: false
  },
  {
    id: "p51",
    name: "Prenda de Autor #51",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "unisex",
    type: "tops",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/51.png"],
    isUnique: true
  },
  {
    id: "p52",
    name: "Prenda de Autor #52",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "mujer",
    type: "bottoms",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/52.png"],
    isUnique: false
  },
  {
    id: "p53",
    name: "Prenda de Autor #53",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "hombre",
    type: "vestidos",
    ...
    condition: "en buen estado",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/53.png"],
    isUnique: true
  },
  {
    id: "p54",
    name: "Prenda de Autor #54",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "unisex",
    type: "accesorios",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/54.png"],
    isUnique: false
  },
  {
    id: "p55",
    name: "Prenda de Autor #55",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 30900,
    category: "mujer",
    type: "abrigo",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/55.png"],
    isUnique: true
  },
  {
    id: "p56",
    name: "Prenda de Autor #56",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "hombre",
    type: "tops",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/56.png"],
    isUnique: false
  },
  {
    id: "p57",
    name: "Prenda de Autor #57",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "unisex",
    type: "bottoms",
    ...
    condition: "en buen estado",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/57.png"],
    isUnique: true
  },
  {
    id: "p58",
    name: "Prenda de Autor #58",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 50900,
    category: "mujer",
    type: "vestidos",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Evitamos la contaminación química asociada a tintes nuevos.",
    images: ["/catalogo-1/58.png"],
    isUnique: false
  },
  {
    id: "p59",
    name: "Prenda de Autor #59",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "hombre",
    type: "accesorios",
    ...
    condition: "en excelente estado",
    environmentalImpact: "Upcycling de material procedente de mermas.",
    images: ["/catalogo-1/59.png"],
    isUnique: true
  },
  {
    id: "p60",
    name: "Prenda de Autor #60",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 30900,
    category: "unisex",
    type: "abrigo",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "Extiende la vida útil, evitando emisiones de carbono.",
    images: ["/catalogo-1/60.png"],
    isUnique: false
  },
  {
    id: "p61",
    name: "Prenda de Autor #61",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "mujer",
    type: "tops",
    ...
    condition: "en buen estado",
    environmentalImpact: "Ahorro de 3,500 litros de agua frente a fabricación nueva.",
    images: ["/catalogo-1/61.png"],
    isUnique: true
  },
  {
    id: "p62",
    name: "Prenda de Autor #62",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 40900,
    category: "hombre",
    type: "bottoms",
    ...
    condition: "en excelente estado",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/62.png"],
    isUnique: false
  },
  {
    id: "p63",
    name: "Prenda de Autor #63",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 20900,
    category: "hombre",
    type: "bottoms",
    ...
    condition: "nuevo con etiqueta",
    environmentalImpact: "100% de la prenda reciclada, fomentando la moda circular en Chile.",
    images: ["/catalogo-1/63.png"],
    isUnique: false
  },
  {
    id: "p64",
    name: "Prenda de Autor #64",
    description: "Auténtica prenda de nuestro lote especial de moda circular. Seleccionada y aprobada bajo estrictos estándares de curaduría experta.",
    price: 60900,
    category: "unisex",
    type: "vestidos",
